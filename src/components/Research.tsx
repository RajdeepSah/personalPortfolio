...
const Research = () => {
  ...
  const publications = [
    {
      title:
        "Generative AI in higher education: student and faculty perspectives on use, ethics, and impact",
      authors:
        "Rajdeep Sah, Dr. Sun, Cameron Hagemaster, Arpan Adhikari, Ari Lee",
      venue:
      ...
      status: "Published",
      description:
        "This study examines how generative AI is impacting college students and faculty, using survey data from 114 students and interviews with 18 professors to compare their perceptions, usage patterns, and concerns. Results show that students view AI as a helpful academic tool, especially for managing workload while faculty remain more cautious, highlighting ethical issues and the need for clearer institutional guidelines.",
      keywords: [
        "Generative AI",
        "student perception",
        "faculty perspective",
      ...
      abstract:
        "The rapid advancement of generative artificial intelligence (AI) technologies presents unprecedented opportunities for transforming higher education. This paper investigates the current state of generative AI applications in educational settings, identifies key opportunities for enhancing learning experiences, and addresses the challenges institutions face in adopting these technologies responsibly.",
    },
    /*
    {
  ...
  */
  ...
  const researchAreas = [
    {
      ...
      icon: Microscope,
      description:
        "Research in advanced AI algorithms, deep learning architectures, and machine learning optimization techniques.",
      focus: [
        "Neural Networks",
        "Deep Learning",
        "Computer Vision",
    ...
    },
    {
      ...
      icon: BookOpen,
      description:
        "Mathematical modeling, optimization theory, and statistical analysis for solving complex real-world problems.",
      focus: [
    ...
    },
    {
      ...
      icon: Award,
      description:
        "Exploring the intersection of technology and education, focusing on AI-driven learning solutions.",
      focus: [
        "Educational AI",
        "Learning Analytics",
        "Adaptive Learning",
  ...
  const upcomingResearch = [
    ...
    },
    {
      ...
      expectedCompletion: "2025",
      description:
        "Designing a scalable, secure digital voting platform with a modular architecture that can integrate blockchain-based audit trails in future versions. The system focuses on cryptographic security, verifiable logs, and user authentication to support transparent and tamper-resistant elections.",
    },
  ];
        ...
        >
          <motion.div variants={itemVariants} className="text-center">
            ...
            <p className="text-xl text-secondary max-w-3xl mx-auto">
              Exploring the frontiers of artificial intelligence, machine
              learning, and mathematical research to solve complex problems and
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-4">
                    <div className="flex-1">
                      <div className="flex items-center mb-3">
                        ...
                        <span
                          className={`text-xs font-medium ${publication.status === "Published" ? "badge-premium badge-success" : "badge-premium badge-warning"}`}
                        >
                          {publication.status}
                        </span>
                      </div>
              ...
              {upcomingResearch.map((research, index) => (
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <span
                      className={`text-xs font-medium ${research.status === "In Progress" ? "badge-premium badge-success" : "badge-premium"}`}
                    >
                      {research.status}
                    </span>
